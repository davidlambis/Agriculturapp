package interedes.agriculturapp.activities.productor.mis_ofertas_productor;
...
public class MisOfertasProductorActivity extends AppCompatActivity implements MisOfertasProductorView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ofertas_productor);
