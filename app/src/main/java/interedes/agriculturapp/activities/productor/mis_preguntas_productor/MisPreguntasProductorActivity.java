package interedes.agriculturapp.activities.productor.mis_preguntas_productor;
...
public class MisPreguntasProductorActivity extends AppCompatActivity implements MisPreguntasProductorView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_productor);
